...
import { authMiddleware, validationErrorMiddleware } from '../middlewares';
...
usersRouter.post('/', userBodyValidator, authMiddleware, validationErrorMiddleware, createUserController);
